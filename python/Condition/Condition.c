...
{BdcSeedsignal_SIGNALNUM, 4, &BdcSeedsignal_Condition},
{BdcWlcmsignal_SIGNALNUM, 2, &BdcWlcmsignal_Condition},
{DLC_u8TurnLightTwice_SIGNALNUM, 1, &DLC_u8TurnLightTwice_Condition},
{EEP_LOGO_ENABLE_FLAG_SIGNALNUM, 4, &EEP_LOGO_ENABLE_FLAG_Condition},
...
{PRM_u8PowerSts_SIGNALNUM, 3, &PRM_u8PowerSts_Condition},
{PRM_u8PowerSts_Pre_SIGNALNUM, 1, &PRM_u8PowerSts_Pre_Condition},
{VcuGearPosn_SIGNALNUM, 5, &VcuGearPosn_Condition},
{VcuGearPosn_Pre_SIGNALNUM, 1, &VcuGearPosn_Pre_Condition}};
