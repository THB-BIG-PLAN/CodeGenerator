...
static const SignalCondition SignalConditionArray[SIGNAL_NUM] = {{BdcSeedsignal_SIGNALNUM,3,&(BdcSeedsignal_Condition)},
...
static const Condition TimeOutActionArray[TIMEOUT_NUM] = {{1,EQ,&(LGL_SEE_OFF)},
{1,EQ,&(LGL_EEP_OFF)},
{1,EQ,&(LGL_PRM_OFF)},
{1,EQ,&(LGL_DLC_OFF)}};
